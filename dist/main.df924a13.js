...
var apiKey = '4588f608573d4e5bb82c6162fb16543c';

var Noticias = /*#__PURE__*/function () {
  function Noticias() {
  ...
  _createClass(Noticias, [{
    key: "getTopNews",
    value: function getTopNews(country) {
      country.toLowerCase();
...
},{"axios":"node_modules/axios/index.js"}],"assets/scripts/main.js":[function(require,module,exports) {
"use strict";

var _noticias = require("./noticias.js");

var noticia = new _noticias.Noticias();
var searchQ = ''; // noticia.getTopNews('us').then(response => {
...
if (searchQ != null) {
  ...
  document.getElementById('btnSubmit').addEventListener('click', function (e) {
    e.preventDefault();
    noticia.getNewsQuery(searchQ.toString()).then(function (response) {
      var news = response.data;
      console.log(news); // get articles
...
},{"./noticias.js":"assets/scripts/noticias.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
